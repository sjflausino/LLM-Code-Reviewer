...
class GeminiClient:
    ...
    def list_commit_code_smells(self, diff_content):
        ...
        prompt = (
            ...
            "- Nome do padrão (ex: Long Method, Magic Number).\n"
            "- Breve descrição contextualizada.\n"
            ...
            "- Se existir, regra ou padrão que define esse code smell ou vulnerabilidade no sonarqube, caso contrário deixar em branco.\n"
